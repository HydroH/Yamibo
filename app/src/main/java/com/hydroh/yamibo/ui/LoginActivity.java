...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            HttpUtil.forumLogin(username, password, new RequestCallbackListener() {
                @Override
                public void onFinish(Map<String, String> cookies) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showProgress(false);
                            Toast.makeText(mUsernameView.getContext(), R.string.login_success, Toast.LENGTH_SHORT).show();
                        }
                    });

                    CookieUtil.getInstance().setCookiePreference(mLoginFormView.getContext(), cookies);
